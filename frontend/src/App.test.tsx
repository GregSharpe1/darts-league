...
describe('App', () => {
  ...
  it('renders live fixtures from the API', async () => {
    ...
    expect(screen.getByRole('heading', { name: /how to submit a score/i })).toBeInTheDocument()
    expect(screen.getByText(/post your result in/i)).toBeInTheDocument()
    expect(screen.getByText(/greg 2 - 1 johnny/i)).toBeInTheDocument()
    expect(screen.getByText(/check fixtures and standings to confirm the update/i)).toBeInTheDocument()
