      ...
      <header className="topbar">
        <div className="brand-mark">
          ...
          <div className="brand-copy">
            ...
            <span>Fixtures in order. Results on record.</span>
          </div>
        </div>
    ...
    <>
      <section className="hero-panel">
        <div className="hero-copy">
          <span className="eyebrow">Match office</span>
          <h1>The match office is open.</h1>
          <p className="fixture-meta">{seasonQuery.data?.name ?? 'Active season'}</p>
          <p>
            Follow the live week, see the upcoming queue, and wait for the Monday morning 09:00 release before the next details are shown.
          </p>
        ...
        <div className="hero-side">
          <article className="metric-card">
            <span className="section-eyebrow">Season desk</span>
          ...
          <article className="info-card">
            <div className="card-header">
              <div className="card-copy">
                <h2>Release clock</h2>
                <p>Upcoming weeks stay listed, with pairings on show and extra detail held until unlock.</p>
              </div>
  ...
  return (
    <section className="standings-card">
      <div className="page-intro">
        <span className="eyebrow">League sheet</span>
        <h1>Standings</h1>
        <p className="fixture-meta">{seasonQuery.data?.name ?? 'Active season'}</p>
        <p>Public labels prefer nicknames, while the table keeps points and leg totals easy to read at a glance.</p>
      </div>
  ...
  return (
    <>
      <section className="page-intro">
        ...
        <h1>Add your name to the slate</h1>
        <p className="fixture-meta">{seasonQuery.data?.name ?? 'Active season'}</p>
      ...
      {seasonQuery.data && !seasonQuery.data.registration_open ? (
        ...
        <section className="register-grid">
          <article className="register-card">
            ...
            <p>Keep it direct for MVP: one required name and one optional darts nickname.</p>
