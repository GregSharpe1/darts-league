      ...
      <header className="topbar">
        <div className="brand-mark">
          ...
          <div className="brand-copy">
            ...
            <span>Weekly unlocks. Clear standings. Quiet confidence.</span>
          </div>
        </div>
    ...
    <>
      <section className="hero-panel">
        <div className="hero-copy">
          ...
          <h1>Fixtures, week by week.</h1>
          <p className="fixture-meta">{seasonQuery.data?.name ?? 'Active season'}</p>
          <p>
            The public board shows the live week in full, keeps future pairings visible, and holds back details until Monday morning at 09:00 Europe/London.
          </p>
        ...
        <div className="hero-side">
          <article className="metric-card">
            <span className="section-eyebrow">League snapshot</span>
          ...
          <article className="info-card">
            <div className="card-header">
              <div className="card-copy">
                <h2>Next unlock</h2>
                <p>Future weeks stay visible with pairings shown and match details intentionally held back.</p>
              </div>
