...
var (
	...
	ErrSeasonRenameLocked    = errors.New("season name can only be changed before the first week is released")
	ErrSeasonConfigLocked    = errors.New("match configuration can only be changed before the first week is released")
	...
	ErrDivisionChannelLocked = errors.New("division channel can only be changed before the first week is released")
